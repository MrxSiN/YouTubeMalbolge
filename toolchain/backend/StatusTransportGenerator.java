...
final class StatusTransportGenerator implements Opcodes {
    ...
    private StatusTransportGenerator() {}
    ...
    static void generate(Path root, GenerateModule.Diagnostic diagnostic) throws IOException {
        ...
        w.visitField(ACC_STATIC | ACC_VOLATILE, "pendingGroups", "Ljava/lang/String;", null, null).visitEnd();
        ...
        m = w.visitMethod(ACC_PUBLIC | ACC_STATIC, "report",
        ...
        m.visitVarInsn(ALOAD, 2); m.visitFieldInsn(PUTSTATIC, STATUS, "pendingGroups", "Ljava/lang/String;");
        ...
        m.visitVarInsn(ALOAD, 3); m.visitJumpInsn(IFNULL, noApp);
        m.visitTypeInsn(NEW, BUNDLE); m.visitInsn(DUP);
        m.visitMethodInsn(INVOKESPECIAL, BUNDLE, "<init>", "()V", false);
        m.visitVarInsn(ASTORE, 4);
        m.visitVarInsn(ALOAD, 4); m.visitLdcInsn("status"); m.visitVarInsn(ALOAD, 0);
        m.visitMethodInsn(INVOKEVIRTUAL, BUNDLE, "putString", "(Ljava/lang/String;Ljava/lang/String;)V", false);
        m.visitVarInsn(ALOAD, 4); m.visitLdcInsn("detail"); m.visitVarInsn(ALOAD, 1);
        m.visitMethodInsn(INVOKEVIRTUAL, BUNDLE, "putString", "(Ljava/lang/String;Ljava/lang/String;)V", false);
        m.visitVarInsn(ALOAD, 4); m.visitLdcInsn("groups"); m.visitVarInsn(ALOAD, 2);
        m.visitMethodInsn(INVOKEVIRTUAL, BUNDLE, "putString", "(Ljava/lang/String;Ljava/lang/String;)V", false);
        ...
        m.visitLdcInsn(GenerateModule.LOG_TAG); m.visitLdcInsn("diagnostic report failed"); m.visitVarInsn(ALOAD, 5);
        ...
        for (String key : new String[] {"status", "detail", "groups"}) {
    ...
    private static void retry(Path root) throws IOException {
        ...
        m.visitFieldInsn(GETSTATIC, STATUS, "pendingGroups", "Ljava/lang/String;");
        m.visitMethodInsn(INVOKESTATIC, STATUS, "report",
